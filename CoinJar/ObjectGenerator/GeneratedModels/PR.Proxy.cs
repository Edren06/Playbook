            ...
            using(SqlConnection _con = new SqlConnection(connectionString))
                using(SqlCommand _cmd = new SqlCommand())
                {
                    ...
                    while(reader.Read())
                    {
                        ...
                        {
                            CoinJarId = (System.Int32) (reader["CoinJarId"].GetType() == typeof(System.DBNull) ? null : reader["CoinJarId"]),
                            Amount = (System.Decimal?) (reader["Amount"].GetType() == typeof(System.DBNull) ? null : reader["Amount"]),
